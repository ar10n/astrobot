...
selfRealizationQuestScene.enter(async (ctx) => {
    await ctx.replyWithHTML(
        'Тебе хотелось бы достичь вершины самореализации?',
